    ...
    <>
      ...
      <section className="section-space">
        <div className="container-shell grid gap-14 lg:grid-cols-[.8fr_1.2fr]">
          <div>
            <h2 className="section-title text-navy">{copy.requirementTitle}</h2>
          ...
          <div className="rounded-[30px] bg-deep-navy p-7 text-white md:p-10">
      ...
      <section className="section-space bg-mist">
        <div className="container-shell grid gap-5 lg:grid-cols-3">
          {[
            [HandCoins, copy.commercialTitle, copy.commercialBody],
            [FileCheck2, copy.transparencyTitle, copy.transparencyBody],
            [Scale, copy.scopeTitle, copy.scopeBody],
          ].map(([Icon, title, body]) => (
            <article className="service-card" key={String(title)}>
              ...
              <p className="mt-3 leading-7 text-slate">{String(body)}</p>
            </article>
          ))}
        </div>
      </section>
